...
function App() {
  return (
    <div className="min-h-screen bg-[var(--color-bg)] text-[var(--color-text)] font-sans antialiased">
      ...
      {/* Placeholder sections so the navbar scroll state is demonstrable */}
      <section id="about" className="min-h-screen flex items-center justify-center px-6">
        <div className="glass-card p-12 text-center max-w-xl w-full">
          <p className="section-title text-3xl mb-4">About</p>
          <p className="text-[var(--color-muted)]">Coming in Phase 4…</p>
        </div>
      </section>
