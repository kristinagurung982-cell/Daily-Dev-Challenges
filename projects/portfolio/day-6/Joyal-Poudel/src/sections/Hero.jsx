      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 w-full pt-28 pb-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="flex flex-col gap-6">
            ...
            >
              I'm <span className="text-[var(--color-text)] font-semibold underline decoration-[var(--color-primary)]/30">Joyal Poudel</span>, a
            ...
            <div
              ref={statsRowRef}
              className="flex items-center gap-8 mt-4 pt-6 border-t border-[var(--glass-border)]"
            >
            ...
            <div ref={socialRowRef} className="flex items-center gap-4 mt-2">
              {socialLinks.map((s) => (
                <a
                  ...
                  aria-label={s.name}
                  className="w-10 h-10 rounded-xl border border-[var(--glass-border)] bg-[var(--glass-bg)] flex items-center justify-center text-[var(--color-muted)] hover:text-[var(--color-primary)] hover:border-[var(--color-primary)] hover:bg-[var(--color-primary)]/10 transition-all duration-250"
                >
                  {s.icon}
                </a>
              ))}
