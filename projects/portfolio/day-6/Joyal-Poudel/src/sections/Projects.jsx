            ...
            >
              <div className="relative h-64 overflow-hidden">
                ...
                <div className="absolute top-4 left-4">
                  <span className="hero-badge text-[10px] uppercase font-bold tracking-widest bg-[var(--color-bg)]/80 backdrop-blur-md px-3 py-1 rounded-full border border-[var(--glass-border)] text-[var(--color-text)]">
                    {project.category}
                  </span>
                </div>
              </div>
              ...
              <div className="p-8">
                <h3 className="text-2xl font-bold text-[var(--color-text)] mb-2 group-hover:text-[var(--color-primary)] transition-colors">
                  {project.title}
                </h3>
                ...
                <div className="flex items-center justify-between mt-auto">
                   <a 
                    href={project.link} 
                    className="flex items-center gap-2 text-sm font-semibold text-[var(--color-text)] group-hover:gap-3 transition-all"
                  >
                    View Project 
